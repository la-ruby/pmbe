  ...
  divs.forEach(function(item) {
    ...
    xhr.onreadystatechange = function() {
      if (xhr.readyState == 4) {
        ...
        elemDiv.style.cssText = 'font-size: 50%; position:absolute;top:40px;left:1px;width:100%;height:100%;opacity:1;z-index:1000;background-color:rgba(0,0,0,0.5);color:white';
